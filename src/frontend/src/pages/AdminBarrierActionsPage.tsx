...
const AdminBarrierActionsPage: React.FC = () => {
    ...
    const fetchActions = async () => {
        ...
        try {
            const res = await fetch(`/api/admin/barriers/${barrierId}/actions/?${params.toString()}`, {
    ...
    return (
        <div style={styles.container}>
            ...
            {actions.map((a) => (
                <div key={a.id} style={styles.card} onClick={() => fetchActionDetail(a.id)}>
                    <strong>#{a.id}</strong> — {actionTypeLabels[a.action_type] || a.action_type}
                    <br />
            ...
            {selectedAction && (
                <div style={styles.detailBox}>
                    ...
                    <button style={styles.closeBtn} onClick={() => { setSelectedAction(null); setPhoneDetails(null); }}>
                        Скрыть детали
                    </button>
                </div>
            )}
