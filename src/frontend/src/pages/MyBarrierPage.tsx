...
const MyBarrierPage: React.FC = () => {
  ...
  const additionalNumbers = [
    ...
    },
    {
      ...
      phone: "+7 999 123 45 68",
      status: "time",
      schedule: ["Пн 10:00 - Пн 18:00", "Ср 10:00 - Ср 18:00"],
    },
  ];
      ...
      <div style={styles.container}>
        ...
        <div style={styles.infoCard}>
          ...
          <div style={styles.limits}>
            ...
            <div>
              Временных номеров - 1<br />
              Использовано - 1
            </div>
            <div>
              Изменений в неделю - 10
              <br />
              Использовано - 5
            </div>
          </div>
          ...
          <div key={idx} style={styles.additionalCard}>
            <div style={styles.row}>
              <div>
                ...
                {item.schedule &&
                  item.schedule.map((s, i) => <p key={i}>Расписание: {s}</p>)}
              </div>
              <div style={styles.icons}>
                ...
                {item.status === "error" && (
                  <FaExclamation style={styles.iconRed} />
                )}
