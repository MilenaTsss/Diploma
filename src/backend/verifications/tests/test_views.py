...
class TestSendVerificationCodeView:
    ...
    def test_send_verification_code(self, api_client):
        ...
        response = api_client.post(reverse("send_code"), {"phone": "+79991234567", "mode": "login"}, format="json")
    ...
    def test_send_verification_code_blocked_user(self, api_client, blocked_user):
        ...
        response = api_client.post(reverse("send_code"), {"phone": blocked_user.phone, "mode": "login"}, format="json")
    ...
    def test_send_verification_code_too_many_attempts(self, api_client, user, mocker):
        ...
        response = api_client.post(reverse("send_code"), {"phone": user.phone, "mode": "login"}, format="json")
